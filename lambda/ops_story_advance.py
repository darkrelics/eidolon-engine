...
def advance_story_business_logic(active_segment_id: str) -> dict:
    ...
    if is_simple_segment(segment_type):  # type: ignore
        ...
        # Extract ClientEvents generated by process_decision_segment
        client_events = active_segment.get("ClientEvents", [])

        # Update active segment with results INCLUDING ClientEvents
        update_segment_processing_status(active_segment_id, outcome, character_updates, client_events)
