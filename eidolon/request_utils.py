...
def get_required_field(body: dict, field: str, field_type: type = str) -> tuple[any | None, str | None]:
    """
...
def get_optional_field(body: dict, field: str, field_type: type = str, default: any = None) -> any:
    """
