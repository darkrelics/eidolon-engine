...
def get_segments_approaching_expiry(max_segments: int) -> list:
    """
    Get ALL segments that will expire within 30 seconds.
    ...
    next_poll_buffer = current_time + 30
...
def get_stuck_mechanical_segments(max_segments: int) -> list:
    ...
    - EndTime > 30 seconds from now (enough time to process)
    ...
    thirty_seconds_future = current_time + 30
    ...
    try:
        ...
        response = dynamo.scan(
            ...
            ExpressionAttributeValues={
                ...
                ":min_time": thirty_seconds_future,
                ":pending": "pending",
