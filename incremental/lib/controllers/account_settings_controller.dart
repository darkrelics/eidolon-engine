...
class AccountSettingsController extends ChangeNotifier {
  ...
  Future<void> signOut({required VoidCallback onSuccess, required Function(dynamic) onError}) async {
    _setLoading(true);
    try {
  ...
  Future<void> deleteAccount({required VoidCallback onSuccess, required Function(dynamic) onError}) async {
    _setLoading(true);
    try {
