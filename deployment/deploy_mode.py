...
def get_stack_description(stack_name: str) -> str:
    ...
    descriptions = {
        ...
        "character": "7 Lambda functions (item APIs, character APIs, archetype)",
        "story": "9 Lambda functions (story APIs, segment APIs, operations), 2 SQS queues, EventBridge, SSM, 1 policy",
        "player": "Cognito User Pool, client, 1 Lambda function (cognito-player-new)",
