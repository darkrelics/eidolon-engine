...
class CDKApiIntegration:
    ...
    def _run_cdk_command(self, args: list[str], env: dict | None = None, capture_output: bool = False) -> subprocess.CompletedProcess:
    ...
    def destroy(self, 
        ...
        try:
            ...
            return {
                "success": True,
                "message": "Stacks destroyed successfully",
                "stacks_destroyed": stacks or ["all"]
            }
    ...
    def bootstrap(self, account: str | None = None, region: str | None = None) -> dict:
        ...
        try:
            ...
            return {
                "success": True,
                "message": f"Bootstrap completed for {bootstrap_region}"
            }
