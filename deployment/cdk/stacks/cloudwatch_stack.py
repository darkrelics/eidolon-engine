...
from aws_cdk import Stack, aws_logs as logs, aws_iam as iam, CfnOutput, RemovalPolicy
...
class CloudWatchStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, game_name: str, retention_days: int = 365, **kwargs) -> None:
        ...
        self.access_policy = iam.ManagedPolicy(
            self,
            f"{game_name}-cloudwatch-access",
            managed_policy_name=f"{game_name}-cloudwatch-access",
