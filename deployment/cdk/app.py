...
class EidolonEngineApp:
    ...
    def create_stacks(self):
        ...
        self.base_lambda_stack = BaseLambdaStack(
            ...
            shared_players_table_name=shared_tables["Players"],
        ...
        if deploy_mud:
            ...
            self.mud_lambda_stack = MudLambdaStack(
                ...
                lambda_bucket=self.s3_stack.lambda_bucket,
                shared_players_table_name=shared_tables["Players"],
                mud_characters_table_name=mud_tables.get("Characters", "mud-characters"),
                mud_items_table_name=mud_tables.get("Items", "mud-items"),
                mud_archetypes_table_name=mud_tables.get("Archetypes", "mud-archetypes"),
                cognito_user_pool_arn=self.cognito_stack.user_pool.user_pool_arn,
